...
This fixture image is for riela package pre-install sandbox experiments.
...
```bash
docker build -t riela-fixture/vendor-egress-allowlist:latest sandbox/vendor-egress-allowlist
```
...
docker run --rm \
  ...
  riela-fixture/vendor-egress-allowlist:latest
```
